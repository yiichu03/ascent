#!/bin/bash
# One B2-only ASCENT-VO submap-v1.1 lane with independent services.
...
DATASET=${ASCENT_SUBMAP_V11_DATASET:?required}
MODE=${ASCENT_SUBMAP_V11_MODE:?required}
SCENES_ROOT=${ASCENT_SUBMAP_V11_SCENES_ROOT:?required}
MANIFEST=${ASCENT_SUBMAP_V11_MANIFEST:?required}
MANIFEST_SHA256=${ASCENT_SUBMAP_V11_MANIFEST_SHA256:?required}
SOURCE_COMMIT=${ASCENT_SUBMAP_V11_SOURCE_COMMIT:?required}
RESOURCE_COMMIT=${ASCENT_SUBMAP_V11_RESOURCE_COMMIT:?required}
POINTNAV_VO_COMMIT=${ASCENT_SUBMAP_V11_POINTNAV_VO_COMMIT:?required}
LANE_ID=${ASCENT_SUBMAP_V11_LANE_ID:?required}
LANE_COUNT=${ASCENT_SUBMAP_V11_LANE_COUNT:?required}
EXPECTED_CHUNKS=${ASCENT_SUBMAP_V11_LANE_EXPECTED_CHUNKS:?required}
EXPECTED_EPISODES=${ASCENT_SUBMAP_V11_LANE_EXPECTED_EPISODES:?required}
STAGE_ROOT=${ASCENT_SUBMAP_V11_STAGE_ROOT:?required}
BASE_PORT=${ASCENT_SUBMAP_V11_BASE_PORT:?required}
DEADLINE_EPOCH=${ASCENT_SUBMAP_V11_DEADLINE_EPOCH:?required}
...
{
  echo schema=ascent_vo_submap_v1_1_lane_v1
  ...
  echo method_version=submap_v1.1
