#!/usr/bin/env python3
"""Strict B2-only submap-v1.3 evidence gate against frozen arm A."""
...
def main() -> int:
        ...
        episode_rows.append(
            {
                ...
                "target_relay_created_count": b2[
                    "target_relay_created_count"
                ],
                "target_relay_action_count": b2[
                    "target_relay_action_count"
                ],
                "target_relay_scan_started_count": b2[
                    "target_relay_scan_started_count"
                ],
                "target_relay_scan_action_count": b2[
                    "target_relay_scan_action_count"
                ],
                "target_relay_finished_count": b2[
                    "target_relay_finished_count"
                ],
                "target_relay_skipped_count": b2[
                    "target_relay_skipped_count"
                ],
    ...
    target_relay_created = sum(
        row["target_relay_created_count"] for row in episode_rows
    )
    exposed = []
    if target_relay_created:
        exposed.append("TARGET_RELAY")
    if handoff_created:
    ...
    summary = {
        "schema": "ascent_vo_submap_v1_3_b2_screen_v1",
        "dataset": args.expected_dataset,
        "mode": args.mode,
        ...
        "mechanism": {
            ...
            "target_relay_created_episodes": sum(
                row["target_relay_created_count"] > 0
                for row in episode_rows
            ),
            "target_relay_created_count": target_relay_created,
            "target_relay_action_count": sum(
                row["target_relay_action_count"]
                for row in episode_rows
            ),
            "target_relay_scan_started_count": sum(
                row["target_relay_scan_started_count"]
                for row in episode_rows
            ),
            "target_relay_scan_action_count": sum(
                row["target_relay_scan_action_count"]
                for row in episode_rows
            ),
            "target_relay_finished_count": sum(
                row["target_relay_finished_count"]
                for row in episode_rows
            ),
            "target_relay_skipped_count": sum(
                row["target_relay_skipped_count"]
                for row in episode_rows
            ),
            "target_relay_outcomes": sum_counters(
                selected_episodes, "target_relay_outcomes"
            ),
            "target_relay_skip_reasons": sum_counters(
                selected_episodes, "target_relay_skip_reasons"
            ),
